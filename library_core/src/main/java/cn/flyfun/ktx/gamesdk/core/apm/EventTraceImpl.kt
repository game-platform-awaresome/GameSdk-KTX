package cn.flyfun.ktx.gamesdk.core.apm
...
import cn.flyfun.ktx.gamesdk.core.entity.bean.LogBean
import cn.flyfun.ktx.gamesdk.core.inter.IEventTrace
...
class EventTraceImpl : IEventTrace {
    ...
    private fun resetSessionParams() {
        ...
        Adjust.removeSessionCallbackParameter("user_name")
